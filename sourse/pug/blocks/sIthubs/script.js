function setItHubs(items) {
	const template = (item) => {
		return `
			<div class="default-slider__slide swiper-slide"data-aos="fade-up" data-aos-duration="700"><img class="object-fit-js" src="${item.avatar}" alt="" loading="lazy"/>
...
function setItHubsPage(items) {
	const template = (item) => {
		return `
			<div class="hub-slide  col-xxl-4 col-lg-6 text-body" data-aos="fade-up" data-aos-duration="700"><img class="object-fit-js" src="${item.avatar}" alt="" loading="lazy"/>
